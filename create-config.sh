...
export K8SHA_VIP=192.168.200.100

# master01 ip address
export K8SHA_IP1=192.168.200.201

# master02 ip address
export K8SHA_IP2=192.168.200.202

# master03 ip address
export K8SHA_IP3=192.168.200.203

# master keepalived virtual ip hostname
export K8SHA_VHOST=k8s-master-lb

# master01 hostname
export K8SHA_HOST1=k8s-master-01

# master02 hostname
export K8SHA_HOST2=k8s-master-02

# master03 hostname
export K8SHA_HOST3=k8s-master-03
...
export K8SHA_CALICO_REACHABLE_IP=192.168.200.1
